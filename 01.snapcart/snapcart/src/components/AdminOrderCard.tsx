...
import { ChevronRight, ChevronUp, CreditCard, MapPin, Package, Phone, Truck, User } from 'lucide-react'
    ...
    >
        <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-4'>
            ...
            <div className='flex flex-col items-start md:items-end gap-2'>
                ...
                <select onChange={(e) => updateStatus(order._id?.toString()!, e.target.value)} value={status} className='border border-gray-300 rounded-lg px-3 py-1 text-sm shadow-sm hover:border-green-400 transition focus:right-2 focus:ring-green-500 outline-none'>
