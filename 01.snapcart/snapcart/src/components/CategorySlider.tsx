...
function CategorySlider() {
    ...
    const categories = [
        ...
        { id:3, name:"Rise, Ata & Grains", icon: Wheat, color:"bg-orange-100" },
        { id:4, name:"Snacks & Biscuits", icon: Cookie, color:"bg-pink-100" },
        { id:5, name:"Spices & Masalas", icon: Flame, color:"bg-red-100" },
        { id:6, name:"Beverage & Drinks", icon: Coffee, color:"bg-blue-100" },
  ...
  return (
    ...
    >
      ...
      { showLeft && (
        <button onClick={()=>scroll("left")} className='absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:bg-green-100 rounded-full h-10 w-10 flex items-center justify-center transition-all'>
      ...
      {showRight && (
        <button onClick={()=>scroll("right")} className='absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:bg-green-100 rounded-full h-10 w-10 flex items-center justify-center transition-all'>
