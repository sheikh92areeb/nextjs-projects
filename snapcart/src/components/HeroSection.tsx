...
function HeroSection() {
    const slides = [
        ...
        },
        {
            ...
            subtitle:"We ensure your groceries reache to your doorstep in on time.",
            btnText:"Order Now",
  ...
  return (
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl shadow-2xl overflow-hidden'>
